  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
      ...
      <div class="lg:col-span-1">
        ...
        >
          <!-- Header -->
          <div class="flex items-center gap-2 pb-4 select-none shrink-0">
          ...
          <!-- Customized Legend -->
          <div class="flex items-center justify-center gap-6 text-xs font-semibold text-neutral-600 pt-4 select-none shrink-0">
