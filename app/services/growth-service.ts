...
export class GrowthService {
    ...
    async getForecastRevenue(period: string): Promise<ApiResponse<GrowthForecastRevenueStats>> {
        try {
            const response = await apiService.client.get<ApiResponse<GrowthForecastRevenueStats>>(`/vp-access-business/growth/forecast-revenue?period=${period}`, this.authHeaders)
            return response.data
        } catch (error: any) {
            return handleServiceError(error)
        }
    ...
    async getAmSnapshot(period: string): Promise<ApiResponse<GrowthAmSnapshotStats>> {
        try {
            const response = await apiService.client.get<ApiResponse<GrowthAmSnapshotStats>>(`/vp-access-business/growth/am-snapshot?period=${period}`, this.authHeaders)
            return response.data
        } catch (error: any) {
            return handleServiceError(error)
        }
